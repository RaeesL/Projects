...
for term in range(len(matrix)):
    matrix[term] = matrix[term].split(" ")
    for num in range(len(matrix[term])):
        matrix[term][num] = int(matrix[term][num])
